...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url(); ?>index.php/crud/index"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Tabel feedback</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Tabel Feedback</div>
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
							    <tr>
							        ...
							        <th data-field="komentar" data-sortable="true">Komemtar</th>
							...
							<tr>
								...
								<td><?php echo $fb['alamat']; ?></td>
								<td><?php echo $fb['komentar']; ?></td>
								<td> <img src="<?php echo base_url("/uploads/" . $fb['img'] ) . ".jpg"; ?>" height="42" width="42" />  </td>
								
								<td align="center"><a href="<?php echo base_url()."index.php/crud/do_delete/".$fb['nama']; ?>"><button>DELETE</button></a></td>
