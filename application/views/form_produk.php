...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url(); ?>index.php/myControl/viewFormProduk"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Forms</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Forms Input Produk</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Form Input Produk</div>
						...
						<div class="col-md-6">
							<form role="form" method="POST" action="<?php echo base_url()."index.php/crud_produk/do_insert"; ?>"  enctype="multipart/form-data">
							
								<div class="form-group">
									<label>Kode Produk</label>
									<input class="form-control" placeholder="Placeholder" name="kode_produk" >
								</div>
								<div class="form-group">
									<label>Nama Produk</label>
									<input class="form-control" placeholder="Placeholder" name="nama_produk" >
								</div>
								<div class="form-group">
									<label>Harga Produk</label>
									<input class="form-control" placeholder="Placeholder" name="harga_produk" >
								</div>
								<div class="form-group">
									<label>File input</label>
									<input type="file" name="fileProduk" size="2000" >
